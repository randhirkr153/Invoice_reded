...
import { 
  LayoutDashboard, FileText, CreditCard, Settings, LogOut, Sun, Moon, Menu, X 
} from 'lucide-react';
      ...
      <aside className="hidden md:flex md:flex-col w-64 bg-white border-r border-slate-200 dark:bg-slate-900 dark:border-slate-800 flex-shrink-0">
        <div className="flex items-center justify-between h-16 px-6 border-b border-slate-200 dark:border-slate-800">
          <Link to="/" className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-lg bg-brand-600 flex items-center justify-center text-white font-bold text-lg">C</div>
            <span className="font-semibold text-lg tracking-wider gradient-text font-sans">CLIENT HUB</span>
          </Link>
        </div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-medium truncate max-w-[120px]">{user?.companyName || user?.name || 'Client'}</span>
